<div class="companies index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('companytype_id');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $company['Company']['title']; ?>&nbsp;</td>
		<td><?php echo $company['Company']['description']; ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($company['Companytype']['title'], array('controller' => 'companytypes', 'action' => 'view', $company['Companytype']['id'])); ?>
		</td>
